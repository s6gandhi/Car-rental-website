...
public class Login extends HttpServlet {
   ...
   @Override
    ...
    private UserInfo getUserInfo(String uname, String password) {
       ...
       try {
           uf.addBook(new CarsRented("Audi Q4", "SUV", new SimpleDateFormat("YYYY-MM-dd").parse("2022-02-01"), true));
           uf.addBook(new CarsRented("BMW M3", "Sedan", new SimpleDateFormat("YYYY-MM-dd").parse("2022-01-20"), false));
